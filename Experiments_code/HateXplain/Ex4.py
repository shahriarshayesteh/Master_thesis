# -*- coding: utf-8 -*-
"""HateXplain (EX4)model design.ipynb
...
''''
def result_saver(file_path,model_results, model,seed_val,data_dic['dataset_initializer'].get_num_label() ):
  model_results = {key: model_results[key] for key in ['performance_metrics','gender_metrics','race_metrics']}

  with open(file_path+"results_{}_{}_{}.txt".format(model,seed_val,data_dic['dataset_initializer'].get_num_label()),"w") as file:
    file.write(json.dumps(model_results))
'''
import sys
sys.path.append('/content/drive/MyDrive/SS_Fair/Models')
import Arch
...
class HateXplain_initializer:

  def __init__(self):

    # address
    self.data = pd.read_csv("/content/drive/MyDrive/SS_Fair/Datasets/HateXplain/HateXplain_train.csv")
    self.data = self.data.rename(columns={'Unnamed: 0'	:'index' })
    
    
    
    self.data_test = pd.read_csv("/content/drive/MyDrive/SS_Fair/Datasets/HateXplain/HateXplain_test.csv")
    self.data_test = self.data_test.rename(columns={'Unnamed: 0'	:'index' })
...
class HateXplain_initializer:
  ...
  def __init__(self):
    ...
    # self.data_test,fair_data_val = train_test_split(self.data_test, test_size=0.6 , random_state=42)
    # self.data_test = self.data_test.reset_index()
...
#       experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_NDA_dic['lda'])+"/"
...
#       experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_GANBERT_dic['lda'])+"/"
#       self.path_maker(experiment_path)
...
#       experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_BERT_dic['lda'])+"/"
#       self.path_maker(experiment_path)
...
class model_initializer:
   ...
   def NDABERT_two_NET(self,params):
      ...
      data_dic = {
          'dataset_initializer':HateXplain_initializer(),
          'seed': 13,
          'label_ratio': 0.05,
          'batch_size':32,
          'max_len': 200,
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/NDABERT/"
   ...
   def FairNDABERT_two_NET(self, params):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])
      path = experiment_path + "/NDABERT/"+ "seed_"+str(data_dic['seed'])+"/"
      self.path_maker(path)
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment" + "/"+dataset_name+"/" +Exp
   ...
   def GANBERT_two_NET(self,params):
      ...
      #experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/GANBERT/"+str(data_dic['label_ratio'])+"/"+ str(params['discriminator_LR'])+str(params['adversary_LR'])+str(params['generator_LR'])+"/"
      
       
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/GANBERT/"
   ...
   def FairGANBERT_two_NET(self,params):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/FairGANBERT/"+str(data_dic['label_ratio'])+"/"
   ...
   def BERT_NET(self,params):
      ...
      #experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/BERT/"+str(data_dic['label_ratio'])+"/"+ str(params['classifier_LR'])+str(params['adversary_LR'])+"/"
      
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/BERT/"
   ...
   def FairBERT_NET(self,params):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"FairBERT/"
   ...
   def FullBERT_NET(self,params):
      ...
      #experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/FullBERT/"+str(data_dic['label_ratio'])+"/"+ str(params['classifier_LR'])+str(params['adversary_LR'])+"/"
      
      #experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/FullBERT/"+str(data_dic['label_ratio'])+"/"
      
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment" + "/"+dataset_name+"/" +Exp+"/FullBERT/"
      self.path_maker(experiment_path)
   ...
   def FullFairBERT_NET(self,params):
      ...
      gender_term = set(['bisexual','female','heterosexual', 'homosexual_gay_or_lesbian','male',"transgender",
      'other_gender', 'other_sexual_orientation'])
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment"+"/"+dataset_name+"/" +Exp+"/" +"/FairFullBERT/"+str(data_dic['label_ratio'])+"/"
...
class FairTextClassification:
    ...
    def __init__(self,dataset_name = "HateXplain", label_ratio = 0.05):

        self.Exp= "HPT_debias"
        self.dataset_name = dataset_name
        self.experiment_path = "/content/drive/MyDrive/SS_Fair/Experiment" + "/"+self.dataset_name+"/" +Exp+"/"+str(label_ratio)
    ...
    def HPT_NDABERT(self,dataset_name = "HateXplain"):
    ...
    def HPT_FairNDABERT(self,lda,dataset_name = "HateXplain"):
    ...
    def HPT_GANBERT(self, dataset_name = "HateXplain"):
    ...
    def HPT_FairGANBERT(self,lda,dataset_name = "HateXplain"):
    ...
    def HPT_BERT(self,dataset_name = "HateXplain"):
    ...
    def HPT_FairBERT(self,lda,dataset_name = "HateXplain"):
    ...
    def HPT_FullBERT(self,dataset_name = "HateXplain"):
    ...
    def HPT_FullFairBERT(self,lda,dataset_name = "HateXplain"):
    ...
    def Ex4(self, dataset_name = "HateXplain"):
      ...
      #root_path = "/content/drive/MyDrive/SS_Fair/HateXplain/Exp4"
      ...
      for lda in lda_list:
        best_FairBERT = self.HPT_FullFairBERT(lda, dataset_name)
      '''
...
FairTextClassification().Ex4("HateXplain")
