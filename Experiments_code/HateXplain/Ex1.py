...
for i in range(len(label_ratio)):
  ...
  output = FairTextClassification().Performance_Experience1(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "HateXplain_NDA_TEST")
  #root_path = "/scratch/shah92/HateXplain/"
