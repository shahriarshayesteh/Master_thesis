...
class model_initializer:
   ...
   def Model_initializer_NDABERT_two_NET(self, data_dic, NDA_dic, Fair_NDA_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/" + Exp+"/" +dataset_name+"/"+str(data_dic['label_ratio'])
...
class FairTextClassification:
    ...
    def Performance_Experience2(self,Model_initializer_list,data_dic, classifier_dic, debiasing_dic, seed_list, label_ratio,dataset_name = "No_name"):
      ...
      for i in range(len( classifier_dic)):
        for seed in seed_list:
          ...
          Model_initializer_list[i]( data_dic[i], classifier_dic[i], debiasing_dic[i],dataset_name,"Exp2")

          root_path = "/content/drive/MyDrive/SS_Fair/Exp2/"
...
for i in range(len(label_ratio)):
  ...
  output = FairTextClassification().Performance_Experience2(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "HateXplain")

  print("88888888888888888888888888888888888888888888888&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&$$$$$$$$$$$$$$$$$$$$$$$$$$$$$444444444444444444444444444")
