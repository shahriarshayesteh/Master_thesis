...
class HateXplain_initializer:
  ...
  def sampler_object_experiment1(self,seed = 42, percentage = 0.005,number_unlabel = 5000):
    ...
    print("number_unlabel",number_unlabel)
...
class model_initializer:
   ...
   def Model_initializer_NDABERT_two_NET(self, data_dic, NDA_dic, Fair_NDA_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/" + Exp+"/" +dataset_name+"/"+str(data_dic['label_ratio'])+"/"+str(data_dic['unlabel_data'])+"/"

      print("1")
      self.path_maker(experiment_path)


      data_dic['dataset_initializer'].sampler_object_experiment1(seed = data_dic['seed'], percentage = data_dic['label_ratio'],number_unlabel = data_dic['unlabel_data'])
...
class FairTextClassification:
    ...
    def Performance_Experience3(self,Model_initializer_list,data_dic, classifier_dic, debiasing_dic, seed_list, label_ratio,dataset_name = "No_name"):
      ...
      for i in range(len( classifier_dic)):
        for seed in seed_list:
          ...
          Model_initializer_list[i]( data_dic[i], classifier_dic[i], debiasing_dic[i],dataset_name,"Exp3")
...
iter_cls = 10
iter_debias = 25 
#unlabel_numbers = [1000,2500,10000]
unlabel_numbers = [10000]

#change
#label_ratio = [0.05, 0.1]
label_ratio = [0.1]

#label_ratio = [0.1]
for unlabel_number in unlabel_numbers:

  data_dic = {
      'dataset_initializer':HateXplain_initializer(),
      'seed': None,
      'label_ratio': None,
      'unlabel_data': unlabel_number,
      'batch_size':32,
      'max_len': 200,
      'GANBERT_flag': True,
      'IW_flag':False 
  ...
  data_dict_list = [data_dic,data_dic]
  ...
  classifier_dic = [NDA_dic,GANBERT_dic]
  ...
  for i in range(len(label_ratio)): 
    ...
    debiasing_dic = [Fair_NDABERT,Fair_GANBERT]

    Model_initializer_list = [model_initializer().Model_initializer_NDABERT_two_NET,model_initializer().Model_initializer_GANBERT_two_NET]

    output = FairTextClassification().Performance_Experience3(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "HateXplain")
    #root_path = "/content/drive/MyDrive/SS_Fair/Exp3/"
