...
class wiki_initializer:
  ...
  def sampler_object_experiment1(self,seed = 42, percentage = 0.005):
    ...
    print("\033[1mnumber_label\033[0m", number_label)
    ...
    non_toxic_proportion_list = [label_non_toxic_dis[0],abs(no_toxic_no_protected - label_non_toxic_dis[0]),label_non_toxic_dis[1]
                                 ,abs(no_toxic_race_protected-label_non_toxic_dis[1]),label_non_toxic_dis[2],abs(no_toxic_gender_protected -label_non_toxic_dis[2])]
    toxic_proportion_list = [label_toxic_dis[0],abs(toxic_no_protected -label_toxic_dis[0]),label_toxic_dis[1],
                             abs(toxic_race_protected -label_toxic_dis[1]),label_toxic_dis[2],abs(toxic_gender_protected-label_toxic_dis[2])]
...
class model_initializer:
   ...
   def Model_initializer_NDABERT_two_NET(self, data_dic, NDA_dic, Fair_NDA_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/content/drive/MyDrive/SS_Fair/Experiments/wiki/" +dataset_name+"/"+ Exp+"/"+str(data_dic['label_ratio'])+"/"
...
#label_ratio = [0.0008,0.0016, 0.0080, 0.0161, 0.0804]
label_ratio = [0.0008]
...
#classifier_dic = [GANBERT_dic]
# classifier_dic = [NDA_dic,GANBERT_dic, BERT_dic]
classifier_dic = [BERT_dic]
...
for i in range(len(label_ratio)):
  ...
  #debiasing_dic = [Fair_GANBERT]
  # debiasing_dic = [Fair_NDABERT,Fair_GANBERT,Fair_BERT_dic]
  debiasing_dic = [Fair_Full_BERT_dic]



  # Model_initializer_list = [model_initializer().Model_initializer_GANBERT_two_NET]
  
  #Model_initializer_list = [model_initializer().Model_initializer_NDABERT_two_NET,model_initializer().Model_initializer_GANBERT_two_NET,model_initializer().Model_initializer_BERT_NET]
  Model_initializer_list = [model_initializer().Model_initializer_Full_supervised_BERT_NET]



  output = FairTextClassification().Performance_Experience1(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "wiki")
  #root_path = "/content/drive/MyDrive/SS_Fair/Experiments/wiki/"
