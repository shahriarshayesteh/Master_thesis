...
seed_list= [12,13,14,15]
iter_cls = 8
iter_debias = 20
#unlabel_numbers = [95000, 10000, 25000]
...
for unlabel_number in unlabel_numbers:
  ...
  for i in range(len(label_ratio)):
    ...
    output = FairTextClassification().Performance_Experience3(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "wiki")
