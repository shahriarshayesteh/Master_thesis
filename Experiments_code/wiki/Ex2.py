...
iter_cls = 8
iter_debias = 15
unlabel_number = 50000

#label_ratio = [0.005,0.01,0.05, 0.1,0.5]
label_ratio = [0.0016, 0.0161]
...
for i in range(len(label_ratio)):
  ...
  output = FairTextClassification().Performance_Experience2(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "wiki")
