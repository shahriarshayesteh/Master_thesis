...
iter_cls = 10
iter_debias = 25 
unlabel_numbers = [1000,2500,5000, 10000]
#change
#label_ratio = [0.005, 0.1]
...
for unlabel_number in unlabel_numbers:
  ...
  for i in range(len(label_ratio)): 
    ...
    output = FairTextClassification().Performance_Experience3(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "jigsaw")
