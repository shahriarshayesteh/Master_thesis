...
def result_saver(file_path,model_results, model,seed_val,num_label_data ):
  model_results = {key: model_results[key] for key in ['performance_metrics','gender_metrics','race_metrics']}

  with open(file_path+"results_{}_{}_{}.txt".format(model,seed_val,num_label_data),"w") as file:
...
import sys
sys.path.append('/project/6001054/shah92/SS-Fair/Experiments/')
...
class jigsaw_initializer:
  ...
  def __init__(self):
    ...
    # address
    self.data = pd.read_csv("/scratch/shah92/jigsaw_train.csv")
    ...
    self.data_test = pd.read_csv("/scratch/shah92/jigsaw_test.csv")
...
class model_initializer:
   ...
   def Model_initializer_NDABERT_two_NET(self, data_dic, NDA_dic, Fair_NDA_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_NDA_dic['lda'])+"/"
      ...
      path_nda = path
      model_nda = "{}_dis_NDABERT_{}.pt".format(num_label_data,seed_value)
      tr_name_nda = "{}_bert_NDABERT_{}.pt".format(num_label_data,seed_value)
      ...
      model_fairNda = "{}_dis_FairNDABERT_{}.pt".format(num_label_data,seed_value)
      tr_name_fairNda = "{}_bert_FairNDABERT_{}.pt".format(num_label_data,seed_value)
   ...
   def Model_initializer_GANBERT_two_NET(self, data_dic, GANBERT_dic, Fair_GANBERT_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_GANBERT_dic['lda'])+"/"
      self.path_maker(experiment_path)
      ...
      model_fairNda = "{}_dis_FairGANBERT_{}.pt".format(num_label_data,seed_value)
      tr_name_fairNda = "{}_bert_FairGANBERT_{}.pt".format(num_label_data,seed_value)
   ...
   def Model_initializer_BERT_NET(self, data_dic, BERT_dic, Fair_BERT_dic,dataset_name = "Noname", Exp = "Exp0"):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/"+str(Fair_BERT_dic['lda'])+"/"
      self.path_maker(experiment_path)
      ...
      path_nda = path
      model_nda = "{}_dis_BERT_{}.pt".format(num_label_data,seed_value)
      tr_name_nda = "{}_bert_BERT_{}.pt".format(num_label_data,seed_value)
      ...
      model_fairNda = "{}_dis_FairBERT_{}.pt".format(num_label_data,seed_value)
      tr_name_fairNda = "{}_bert_FairBERT_{}.pt".format(num_label_data,seed_value)
...
class model_initializer:
   ...
   def NDABERT_two_NET(self,params):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/NDABERT/"
   ...
   def FairNDABERT_two_NET(self, params):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])
      path = experiment_path + "/NDABERT/"+ "seed_"+str(data_dic['seed'])+"/"
      self.path_maker(path)
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+ "/" + Exp+"/" 
   ...
   def GANBERT_two_NET(self,params):
      ...
      #experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/GANBERT/"+str(data_dic['label_ratio'])+"/"+ str(params['discriminator_LR'])+str(params['adversary_LR'])+str(params['generator_LR'])+"/"
      
       
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/GANBERT/"
   ...
   def FairGANBERT_two_NET(self,params):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/FairGANBERT/"+str(data_dic['label_ratio'])+"/"
   ...
   def BERT_NET(self,params):
      ...
      #experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/BERT/"+str(data_dic['label_ratio'])+"/"+ str(params['classifier_LR'])+str(params['adversary_LR'])+"/"
      
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +str(data_dic['label_ratio'])+"/BERT/"
   ...
   def FairBERT_NET(self,params):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"FairBERT/"
   ...
   def FullBERT_NET(self,params):
      ...
      #experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/FullBERT/"+str(data_dic['label_ratio'])+"/"+ str(params['classifier_LR'])+str(params['adversary_LR'])+"/"
      
      #experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/FullBERT/"+str(data_dic['label_ratio'])+"/"
      
      experiment_path = "/scratch/shah92/" + Exp+"/" +dataset_name+"/FullBERT/"
      self.path_maker(experiment_path)
   ...
   def FullFairBERT_NET(self,params):
      ...
      experiment_path = "/scratch/shah92/"+dataset_name+"/" +Exp+"/" +"/FairFullBERT/"+str(data_dic['label_ratio'])+"/"
...
class FairTextClassification:
    ...
    def __init__(self,dataset_name = "jigsaw", label_ratio = 0.05):

        self.Exp= "HPT_debias"
        self.experiment_path = "/scratch/shah92/" + self.Exp+"/" +dataset_name+"/"+str(label_ratio)
    ...
    def HPT_NDABERT(self,dataset_name = "jigsaw"):
    ...
    def HPT_FairNDABERT(self,lda,dataset_name = "jigsaw"):
    ...
    def HPT_GANBERT(self, dataset_name = "jigsaw"):
    ...
    def HPT_FairGANBERT(self,lda,dataset_name = "jigsaw"):
    ...
    def HPT_BERT(self,dataset_name = "jigsaw"):
    ...
    def HPT_FairBERT(self,lda,dataset_name = "jigsaw"):
    ...
    def HPT_FullBERT(self,dataset_name = "jigsaw"):
    ...
    def HPT_FullFairBERT(self,lda,dataset_name = "jigsaw"):
    ...
    def Ex4(self, dataset_name = "jigsaw"):

      print("_"*20)
      
      print("_"*20)
      lda_list = [1,10,30,50,100,150,300]
      ...
      #root_path = "/scratch/shah92/jigsaw/Ex4"
      ...
      for lda in lda_list:
        best_FairFullBert = self.HPT_FullFairBERT(lda, dataset_name)
...
FairTextClassification().Ex4("jigsaw1")
