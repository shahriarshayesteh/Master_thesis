...
class jigsaw_initializer:
  ...
  def sampler_object_experiment1(self,seed = 42, percentage = 0.005):
    ...
    #5000
    number_unlabel = 5000
    number_label = math.ceil(number_unlabel*percentage)
...
data_dict_list = [data_dic,data_dic,data_dic_BERT]
...
for i in range(len(label_ratio)):
  ...
  debiasing_dic = [Fair_NDABERT,Fair_GANBERT,Fair_BERT_dic,Fair_BERT_dic]
  ...
  output = FairTextClassification().Performance_Experience2(Model_initializer_list,data_dict_list, classifier_dic, debiasing_dic, seed_list,label_ratio[i], "jigsaw")
  
  root_path = "/scratch/shah92/"
